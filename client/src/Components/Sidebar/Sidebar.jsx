        ...
        <div className="p-0 min-vh-100 side-bar-bg-color">
          <ul className="text-light list-unstyled">
            ...
            <li className="p-3 pe-lg-5 sidebar-element">
              <Link to="/home" className="nav-link px-0 px-lg-2">
                {" "}
            ...
            {/* <li className="p-3 pe-lg-5 sidebar-element">
             ...
             <li className="p-3 pe-lg-5 sidebar-element">
              <Link to="/none-return-books" className="nav-link px-0 px-lg-2">
                {" "}
            ...
            <li className="p-3 pe-lg-5 sidebar-element">
              <Link to="/recommended" className="nav-link px-0 px-lg-2">
                {" "}
                <i className="fa-solid fa-thumbs-up"></i>
                <span className="px-lg-2 ms-1 d-none d-lg-inline">
                  Recommended
